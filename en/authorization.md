...
`IsLoggedIn`, `UserDefinition`, `UserId`, `Username` and `HasPermission` makes use of corresponding service for you to access information easier about current user.
